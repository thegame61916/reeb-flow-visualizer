...
Domain/range target disagreement, however, does peak near the synthetic
transition, for example at \(48\)--\(49\) and \(49\)--\(50\). This provides a
useful explanation of the transition: range and domain criteria can select
different targets for the same source sheets near the controlled
